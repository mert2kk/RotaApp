    ...
    <div>
        <form @submit.prevent="submitForm">
            <div class="card flex justify-content-center">
                <Dialog :visible="visible" :style="{ width: '50vw' }" close-icon="false"
                    content-class="bg-gray-300 p-3 m-auto  rounded-lg  w-96 drop-shadow-2xl		">
                    ...
                    <div class="flex flex-col">
                        <div class="flex flex-col m-auto">
                            ...
                            <input class="w-80 rounded-lg p-3" v-model="task.title" placeholder="Add a Title" />
                        </div>
                        <div class="flex flex-col m-auto">
